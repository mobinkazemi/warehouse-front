    ...
    <div className="p-6 h-full">
            ...
            <div className="p-5">
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="flex items-start gap-1">
                  <Tag className="ml-1.5 text-[#FE7E05] mt-0.5 flex-shrink-0" size={16} />
                  <div>
                ...
                <div className="flex items-start gap-1">
                  <Briefcase className="ml-1.5 text-[#FE7E05] mt-0.5 flex-shrink-0" size={16} />
                  <div>
                ...
                <div className="flex items-start gap-1">
                  <Barcode className="ml-1.5 text-[#FE7E05] mt-0.5 flex-shrink-0" size={16} />
                  <div>
                ...
                <div className="flex items-start gap-1">
                  <ScanLine className="ml-1.5 text-[#FE7E05] mt-0.5 flex-shrink-0" size={16} />
                  <div>
              ...
              {product.description && (
                <div className="mb-4 flex items-start gap-1">
                  <FileText className="ml-1.5 text-[#FE7E05] mt-0.5 flex-shrink-0" size={16} />
                  <div>
      ...
      {filteredProducts.length === 0 && (
        ...
        >
          ...
          <p className="text-gray-400 text-sm mt-1">لطفا معیارهای جستجو را تغییر دهید یا محصول جدیدی اضافه کنید</p>
        </motion.div>
      )}
    </div>
  );
